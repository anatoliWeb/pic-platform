...
| `examples-projects/xc8/input/digital_input.X` | Simulation/debug demo for debounced raw input and latch behavior | `libraries/input/digital_input/digital_input.c` | none | None | No board pins; synthetic raw levels and timestamps | none | Not present in repo | simulation/debug demo |
| `examples-projects/xc8/sensors/tachometer.X` | Simulation/debug demo for pulse-to-RPM conversion and diagnostics | `libraries/sensors/tachometer/tachometer.c` | none | None | No board pins; synthetic pulses and timestamps | none | Not present in repo | simulation/debug demo |
| `examples-projects/xc8/actuator/cooldown_output.X` | Simulation/debug demo for requested/active cooldown output behavior | `libraries/actuator/cooldown_output/cooldown_output.c` | none | None | No board pins; synthetic requests and timestamps | none | Not present in repo | simulation/debug demo |
