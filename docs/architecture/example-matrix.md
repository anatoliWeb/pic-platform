...
| `examples-projects/xc8/actuator/position_drive_adc.X` | Closed-loop position drive with an ADC potentiometer sensor | `libraries/actuator/position_drive/position_drive.c`, `libraries/system/uart_debug/uart_debug.c` | `drivers/analog/adc/adc.c`, `drivers/gpio/gpio.c`, `drivers/timers/tick/tick.c`, `drivers/timers/timer1/timer1.c`, `core/delay.c` | Timer1 owned by `tick` | `RA0/AN0` potentiometer, `RD0/RD1` H-bridge, `RC6` UART TX | `examples-projects/hex/xc8/actuator/position_drive_adc.X.production.hex` | Not present in repo | example-tested |
