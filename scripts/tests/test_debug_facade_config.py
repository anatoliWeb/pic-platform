...
class DebugFacadeConfigTests(unittest.TestCase):
    ...
    def test_display_auto_init_is_gated(self) -> None:
        ...
        lcd_i2c = read_text("libraries/display/lcd_hd44780/lcd_i2c.c")
        self.assertIn('void debug_display_init(void)', display_backend)
        self.assertIn('display_reset_cursor_state();', display_backend)
        self.assertIn('#if DRV_DEBUG_DISPLAY_AUTO_INIT', display_backend)
        self.assertIn('debug_lcd_clear();', display_backend)
        self.assertIn('display_sync_cursor();', display_backend)
    ...
    def test_configuration_source_trees_are_exact(self) -> None:
        expected = {
            'examples-projects/xc8/debug/default_uart.X/nbproject/configurations.xml': [
                'main.c',
                'config_bits.c',
                '../../../../core/delay.c',
            ...
            'examples-projects/xc8/debug/display_i2c.X/nbproject/configurations.xml': [
                'main.c',
                'config_bits.c',
                '../../../../core/delay.c',
            ...
            'examples-projects/xc8/debug/display_parallel.X/nbproject/configurations.xml': [
                'main.c',
                'config_bits.c',
                '../../../../core/delay.c',
                '../../../../drivers/gpio/gpio.c',
            ...
            'examples-projects/xc8/debug/pins_gpio.X/nbproject/configurations.xml': [
                'main.c',
                'config_bits.c',
                '../../../../core/delay.c',
                '../../../../drivers/gpio/gpio.c',
            ...
            'examples-projects/xc8/debug/multi_backend.X/nbproject/configurations.xml': [
                'main.c',
                'config_bits.c',
                '../../../../core/delay.c',
                '../../../../drivers/communication/uart/uart.c',
            ...
            'examples-projects/xc8/debug/disabled.X/nbproject/configurations.xml': [
                'main.c',
                'config_bits.c',
                '../../../../core/delay.c',
            ],
    ...
    def test_readmes_use_real_make_command(self) -> None:
        for path in (
            'examples-projects/xc8/debug/default_uart.X/README.md',
            'examples-projects/xc8/debug/default_uart.X/README.ua.md',
            'examples-projects/xc8/debug/display_i2c.X/README.md',
            'examples-projects/xc8/debug/display_i2c.X/README.ua.md',
            'examples-projects/xc8/debug/display_parallel.X/README.md',
            'examples-projects/xc8/debug/display_parallel.X/README.ua.md',
            'examples-projects/xc8/debug/pins_gpio.X/README.md',
            'examples-projects/xc8/debug/pins_gpio.X/README.ua.md',
            'examples-projects/xc8/debug/multi_backend.X/README.md',
            'examples-projects/xc8/debug/multi_backend.X/README.ua.md',
            'examples-projects/xc8/debug/disabled.X/README.md',
            'examples-projects/xc8/debug/disabled.X/README.ua.md',
        ):
            with self.subTest(path=path):
                text = read_text(path)
    ...
    def test_text_files_end_with_newline(self) -> None:
        paths = [
            ...
            'examples-projects/xc8/debug/multi_backend.X/nbproject/configurations.xml',
            'examples-projects/xc8/debug/disabled.X/nbproject/configurations.xml',
            'examples-projects/xc8/debug/default_uart.X/nbproject/project.xml',
            'examples-projects/xc8/debug/display_i2c.X/nbproject/project.xml',
            'examples-projects/xc8/debug/display_parallel.X/nbproject/project.xml',
            'examples-projects/xc8/debug/pins_gpio.X/nbproject/project.xml',
            'examples-projects/xc8/debug/multi_backend.X/nbproject/project.xml',
            'examples-projects/xc8/debug/disabled.X/nbproject/project.xml',
        ]
